...
class _PhoneNumberPageState extends State<PhoneNumberPage> {
  ...
  void _clearPhoneNumber(BuildContext context) {
    // context here is from the builder
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<PhoneNumberCubit, BaseFormState>(
          ...
          listener: (context, state) {
            // This 'context' is a descendant and valid
          ...
          builder: (context, state) {
            ...
            final expectedText = state.fields[PhoneNumberCubit.phoneNumberKey]
                    ?.value as String? ??
                '';
