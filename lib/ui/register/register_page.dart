                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocBuilder<RegisterCubit, BaseFormState>(
                              ...
                              builder: (context, fieldState) {
                                return AppTextField(
                                  label: "Last Name",
                                  value: fieldState
                                      .fields[RegisterCubit.lastNameKey]?.value,
                                  errorText: fieldState
                            ...
                            BlocBuilder<RegisterCubit, BaseFormState>(
                              ...
                              builder: (context, fieldState) {
                                return AppTextField(
                                  ...
                                  value: fieldState
                                      .fields[RegisterCubit.usernameKey]?.value,
                                  onChanged: (value) => cubit.updateField(
                            ...
                            BlocBuilder<RegisterCubit, BaseFormState>(
                              ...
                              builder: (context, fieldState) {
                                return AppTextField(
                                  ...
                                  value: fieldState
                                      .fields[RegisterCubit.emailKey]?.value,
                                  errorText: fieldState
                            ...
                            BlocBuilder<RegisterCubit, BaseFormState>(
                              ...
                              builder: (context, fieldState) {
                                ...
                                return AppTextField(
                                  ...
                                  value: fieldState
                                      .fields[RegisterCubit.passwordKey]?.value,
                                  errorText: fieldState
                            ...
                            BlocBuilder<RegisterCubit, BaseFormState>(
                              ...
                              builder: (context, state) {
                                // Corrected: Uses 'state' as per subtask for this field
